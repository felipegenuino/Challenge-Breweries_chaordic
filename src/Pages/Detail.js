             ...
             <section className="Brewery-card">
                <div className="Brewery-card__content">
                    ...
                    <ul  className="Brewery-card__list"> 
                        ...
                        <li>  <strong> Website: </strong>   {data?.website_url ? <a href={data.website_url} target="_blank"> {data.website_url}</a> : 'Não cadastrado'} </li>
                        ...
                        <li>  <strong> Open in maps: </strong>   {data?.latitude && data?.longitude  ? <a href={`http://maps.google.com/maps?&z=15&mrt=yp&t=p&q=${data.latitude}+${data.longitude}`} target="_blank"> {data.latitude} {data.longitude} </a> : 'Não cadastrado'} </li>
                   </ul> 
                 </div>
